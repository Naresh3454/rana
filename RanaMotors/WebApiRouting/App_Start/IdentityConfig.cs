...
namespace WebApiRouting
{
    public class EmailService : IIdentityMessageService
    {
        ...
        internal void SendMail(IdentityMessage message)
        {
            try
            {
                #region formatter
                ...
                msg.From = new MailAddress("gmail account ID");
                ...
                System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("gmail account ID", "Password");
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<SecurityContext>()));
